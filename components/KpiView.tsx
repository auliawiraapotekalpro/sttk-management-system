...
export const KpiView: React.FC<KpiViewProps> = ({ sttkData }) => {
  ...
  const kpiData = useMemo((): KpiData => {
    ...
    // FIX: Add a type to the reduce accumulator to ensure 'submissionsByAm' is correctly typed as Record<string, number>.
    // This resolves the type error for the 'kpiData' return value.
    ...
    // FIX: Explicitly cast values to Number before performing an arithmetic operation to prevent type errors.
